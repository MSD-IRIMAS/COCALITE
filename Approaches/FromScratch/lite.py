...
class LITE:
    ...
    def build_model(self):
        ...
        output_layer = tf.keras.layers.Dense(units=self.n_classes, activation="softmax", kernel_initializer=initializer)(gap)
    ...
    def fit(self, xtrain, ytrain, xval=None, yval=None, plot_test=False):
        ...
        if plot_test:
            hist = self.model.fit(xtrain, ytrain, batch_size=self.batch_size, epochs=self.n_epochs, verbose=self.verbose, validation_data=(xval, yval), callbacks=self.callbacks)
        else:
            hist = self.model.fit(xtrain, ytrain, batch_size=self.batch_size, epochs=self.n_epochs, verbose=self.verbose, callbacks=self.callbacks)
    ...
    def fit_and_track_emissions(self, xtrain, ytrain, xval=None, yval=None, plot_test=False):
